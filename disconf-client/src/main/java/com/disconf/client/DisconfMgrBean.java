...
import com.disconf.core.common.utils.DisconfStringUtils;
...
import com.disconf.client.store.aspect.DisconfAspectJ;
...
public class DisconfMgrBean implements BeanDefinitionRegistryPostProcessor, PriorityOrdered, ApplicationContextAware {
    ...
    public DisconfMgrBean(String scanPackage) {
        this.scanPackage = scanPackage;
    }
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        // unique
        Set<String> scanPackList = DisconfStringUtils.parseStringToStringSet(scanPackage, SCAN_SPLIT_TOKEN);
