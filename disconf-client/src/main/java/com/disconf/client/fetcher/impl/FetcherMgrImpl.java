package com.disconf.client.fetcher.impl;
...
import com.disconf.core.common.constants.Constants;
import com.disconf.core.common.json.ValueVo;
...
public class FetcherMgrImpl implements FetcherMgr {
    ...
    public String getValueFromServer(String url) throws Exception {
        ...
        Response response = restfulMgr.getJsonData(Response.class, remoteUrl, retryTime, retrySleepSeconds);
        LOGGER.debug(url + "  return: " + response);
