...
import com.disconf.client.common.annotations.DisconfFile;
import com.disconf.client.common.annotations.DisconfFileItem;
import com.disconf.client.common.annotations.DisconfUpdateService;
import com.disconf.client.common.constants.Constants;
...
import com.disconf.client.common.annotations.DisconfActiveBackupService;
import com.disconf.client.common.annotations.DisconfItem;
import com.disconf.client.scan.inner.common.ScanVerify;
...
public class ReflectionScanStatic implements ScanStaticStrategy {
     ...
     * 通过扫描，获取反射对象
     */
    private Reflections getReflection(Collection<String> packNameList) {
     ...
     * 扫描基本信息
     */
    private ScanStaticModel scanBasicInfo(Collection<String> packNameList) {
