package com.disconf.client.support;

import java.lang.reflect.Field;
import java.lang.reflect.Modifier;
import java.util.Properties;

import com.disconf.client.common.annotations.DisconfFileItem;
import com.disconf.client.config.inner.DisInnerConfigAnnotation;
import com.disconf.client.support.utils.ClassUtils;
 ...
 * @version 2014-6-6
 */
public final class DisconfAutowireConfig {

    private DisconfAutowireConfig() {

    }

    protected static final Logger LOGGER = LoggerFactory.getLogger(DisconfAutowireConfig.class);
     ...
     */
    public static void autowireConfigWithSystemEnv(final Object obj) throws Exception {
        ...
        try {
            ...
            throw new Exception("error while autowireConfigWithSystemEnv autowire config file", e);
        }
    }
     ...
     * @Description: auto ware
     */
    private static void autowireConfig(final Object obj, Properties prop) throws Exception {
        try {
     ...
     * @throws Exception
     */
    public static void autowireConfig(final Object obj, final String propertyFilePath) throws Exception {

        // 读配置文件
        Properties prop = getProperties(propertyFilePath);
        if (null == prop || obj == null) {
            throw new Exception("cannot autowireConfig " + propertyFilePath);
        }

        autowireConfig(obj, prop);
    }
    ...
    private static void autowareStaticConfig(Class<?> cls, Properties prop) throws Exception {
        ...
        if (null == prop) {
            throw new Exception("cannot autowireConfig null");
        }
