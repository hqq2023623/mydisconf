package com.disconf.client.support.utils;
...
//            URL url = Thread.currentThread().getContextClassLoader().getResource(propertyFilePath);
//            URI uri = new URI(url.toString());
            try(InputStreamReader reader = new InputStreamReader(new FileInputStream(propertyFilePath), "utf-8")) {
                props.load(reader);
            }
