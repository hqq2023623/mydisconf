...
<#assign currentMenu="${currentEnv.name}">
    ...
    <div class="box box-primary">
        <form id="searchForm" onkeydown="if(event.keyCode==13){return false;}">
            <div class="box-header with-border">
                <h3 class="box-title">${currentEnv.name}环境</h3>
            </div>
            <div class="box-body">
        ...
        <div class="box-body with-border">
            ...
            <table id="table_content"
                   ...
                   data-query-params="configParams"
...
<script id="saveModelTpl" type="text/html">
    <form id="saveForm">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-2">
                    <label>环境：${currentEnv.name}</label>
                    <input type="hidden" name="envId" value="${currentEnv.id}"/>
...
<script>
    var currentEnvId = ${currentEnv.id};
</script>
