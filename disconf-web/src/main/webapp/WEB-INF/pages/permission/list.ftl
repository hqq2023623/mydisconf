...
<#assign currentMenu="permissionList">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input class="form-control" name="name" placeholder="权限名称"/>
                        </div>
                        <div class="col-md-3">
        ...
        <div class="box-body with-border">
            ...
            <table id="table_content"
                ...
                <tr>
                    ...
                    <th data-field="parentId">父权限ID</th>
                    <th data-field="parentName">父权限名称</th>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6"><label>权限名称</label>
                    ...
                    <input type="text" class="form-control" name="name" placeholder="权限名称" value="{{= d.name}}">
                </div>
...
<script src="${request.contextPath}/static/app/js/user/permission.js"></script>
